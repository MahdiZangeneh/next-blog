...
const host = "http://next-blog-mu-mauve.vercel.app";
...
const SinglePost: NextPage<Props> = ({ post }) => {
  ...
  const getLikeLabel = useCallback((): string => {
    ...
    if (likedByOwner) return `You and ${count - 1}`;
...
> = async ({ params }) => {
  try {
    ...
    // fetching related posts with tags
    ...
    const postAuthor = {
      ...
      message: `This post is writtern by ${authorInfo.name}. ${
